  ...
  try {
    ...
    const checkInterval = setInterval(async () => {
      try {
        ...
        console.log(typeof(runStatus.data));
        // Parse the JSON string
        var jsonObject = JSON.parse(runStatus.data);
        console.log(jsonObject);
        // Extract the status value
        var statusValue = jsonObject.data[0].status;

        console.log(statusValue);
        //console.log(JSON.stringify(runStatus.data[0]));
        ...
        if (runStatus.data[0].status === 'completed') {
          ...
          console.log(JSON.stringify(messagesResponse.data[0].content[0].text.value));
          console.log(res.json({ messages: messagesResponse.data.data }));
